#' Make an Entrez Gene Summary table which includes the genes symbol,
...
#' 
#' @param outfile undocumented parameter
#' @param taxid undocumented parameter
#' 
#' @return a \code{data.frame} with the following columns: 
#' c("GeneID", "Symbol",
#' "Description", "Synonym", "GenbankID", "mgiID", "Chr", "Start", "Stop",
#' "Strand", "cM") 
...
make.gene.summary <- function(outfile="/biomirror/mouse/Gene/gene.summary.mm.txt",
    ...
    gene2refseq$GenbankID <- sub("\\..*", "", gene2refseq$RNAacc)
